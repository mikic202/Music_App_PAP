...
public class UploadAccessors {
	...
	public JSONObject startUpload(int user_id, String file_name) {
        JSONObject procesed_request = UploadRequestCreator.create_start_upload_request(user_id, file_name);
