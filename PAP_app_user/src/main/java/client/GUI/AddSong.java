...
public class AddSong extends javax.swing.JFrame {
        ...
        public AddSong(int userId, ServerConnector connector) {
                this.user_id = userId;
        ...
        private void initComponents() {
                ...
                jButton1.addActionListener(new java.awt.event.ActionListener() {
                        public void actionPerformed(java.awt.event.ActionEvent evt) {
                                ...
                                String uuid = accessors.startUpload(user_id, name).getJSONObject("value")
                                                .getString("uuid");
                ...
                layout.setHorizontalGroup(
                                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                .addComponent(jFileChooser1, javax.swing.GroupLayout.DEFAULT_SIZE, 800,
                                                                Short.MAX_VALUE)
        ...
        // java.util.logging.Logger.getLogger(AddSong.class.getName()).log(java.util.logging.Level.SEVERE,
        // null, ex);
