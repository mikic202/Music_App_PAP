...
public class CreateGroup extends javax.swing.JFrame {
        ...
        public CreateGroup(MainScreen main_screen) {
        ...
        private ArrayList<String> parse_users() {
                ...
                String[] parsed_usernames = jTextField2.getText().split(";");
        ...
        private void initComponents() {
                ...
                jTextField2.setText("user1;user2");
        ...
        public static void main(String args[]) {
                ...
                try {
                        ...
                        java.util.logging.Logger.getLogger(CreateGroup.class.getName()).log(
